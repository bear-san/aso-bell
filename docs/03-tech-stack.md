...
| Discord | `github.com/bwmarrin/discordgo` | 5,985 | **BSD-3-Clause** | v0.29.1-0.20260214123928-f43dd94faaac(master 固定) | 例外採用(→ §2.1、§2.6) |
...
| WebSocket | `github.com/gorilla/websocket` | 23,077 | **BSD-2-Clause** | v1.4.2 | discordgo の必須依存(Gateway 接続)。BSD 許容済み |
